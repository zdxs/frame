 ...
 * ----------------------------------------------------------------------------------
 * ---------------------------------------------------------------- Windows XP
 * SP3 Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.1) Gecko/20090624
 * Firefox/3.5 (.NET CLR 3.5.30729) ----
 * ----------------------------------------------------------------------------------------------
 * ------------------------------------------------ Windows Vista Mozilla/5.0
 * (Windows; U; Windows NT 6.1; nl; rv:1.9.2.13) Gecko/20101203 Firefox/3.6.13
 * Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US; rv:1.9.2.6) Gecko/20100625
 * Firefox/3.6.6 (.NET CLR 3.5.30729) ------------------------------
 * --------------------------------------------------------------------
 * ------------------------------------------------ windows 2000 Mozilla/5.0
 * (Windows; U; Windows NT 5.0; en-GB; rv:1.8.1b2) Gecko/20060821 Firefox/2.0b2
 * ----------------------------------------------
 * ----------------------------------------------------
 ...
 * ------------------------------------------------------------------------------------------
 * ------------------------------------------------ Mac OS X Mozilla/5.0
 * (Macintosh; U; Intel Mac OS X 10.6; en-US; rv:1.9.2.9) Gecko/20100824
 * Firefox/3.6.9 ------------------------------------------
 * --------------------------------------------------------
 * ------------------------------------------------
 *
 ...
 * Safari/531.21.10 ----------------------------------------------
 * ----------------------------------------------------
 * ------------------------------------------------ iPad 2 Mozilla/5.0 (iPad;
 * CPU OS 5_1 like Mac OS X; en-us) AppleWebKit/534.46 (KHTML, like Gecko)
 * Version/5.1 Mobile/9B176 Safari/7534.48.3 --------
 * ------------------------------------------------------------------------------------------
 * ------------------------------------------------ iPhone 4 Mozilla/5.0
 * (iPhone; U; CPU iPhone OS 4_0 like Mac OS X; en-us) AppleWebKit/532.9 (KHTML,
...
public class BrowserCheck {
     ...
     * 获取访问的浏览器类型
     *
     * @param agent=request.getHeader("User-Agent").toLowerCase();
     * @return
     */
    public static String BrowseName(String agent) {
        BrowserCheck b = new BrowserCheck();
        String browsename = b.getBrowser(agent);
        return browsename;
    }
     ...
     * @return
     */
    public static BrowserBean getUserAgent(String userAgent) {
        ...
        if (userAgent.contains("Windows")) {// 主流应用靠前
            ...
            } else if (userAgent.contains("Windows 98; Win 9x 4.90")) {// Windows Millennium Edition
                // (Windows Me)
            ...
            /**
             * ******** 苹果系列 ******** iPod - Mozilla/5.0 (iPod; U; CPU iPhone
             * OS 4_3_1 like Mac OS X; zh-cn) AppleWebKit/533.17.9 (KHTML, like
     ...
     * @return
     */
    private static BrowserBean judgeBrowser(String userAgent, String platformType,
        ...
        if (userAgent.contains("Chrome")) {
             ...
             */
            String temp = userAgent.substring(userAgent.indexOf("Chrome/") + 7);// 拿到User Agent String
            // "Chrome/"
            ...
            return new BrowserBean("Chrome", chromeVersion, platformType, platformSeries, platformVersion);
             ...
             */
            String temp = userAgent.substring(userAgent.indexOf("Firefox/") + 8);// 拿到User Agent String
            // "Firefox/"
            ...
            return new BrowserBean("Firefox", ffVersion, platformType, platformSeries, platformVersion);
            ...
            if (userAgent.contains("MSIE 10.0")) {// Internet Explorer 10
                return new BrowserBean("Internet Explorer", "10", platformType, platformSeries,
                        platformVersion);
            } else if (userAgent.contains("MSIE 9.0")) {// Internet Explorer 9
                return new BrowserBean("Internet Explorer", "9", platformType, platformSeries,
                        platformVersion);
            } else if (userAgent.contains("MSIE 8.0")) {// Internet Explorer 8
                return new BrowserBean("Internet Explorer", "8", platformType, platformSeries,
                        platformVersion);
            } else if (userAgent.contains("MSIE 7.0")) {// Internet Explorer 7
                return new BrowserBean("Internet Explorer", "7", platformType, platformSeries,
                        platformVersion);
            } else if (userAgent.contains("MSIE 6.0")) {// Internet Explorer 6
                return new BrowserBean("Internet Explorer", "6", platformType, platformSeries,
                        platformVersion);
            }
        } else {// 暂时支持以上三个主流.其它浏览器,待续...
            return new BrowserBean(null, null, platformType, platformSeries, platformVersion);
        }
        return null;
    }

    public String getClient(String agent, String[] types) {
        return null;
    }
    ...
    public String getBrowserName(String agent) {
        if (agent.indexOf("msie 7") > 0) {
            ...
            return "ie10";
        } else if (agent.indexOf("msie 11") > 0) {
            return "ie11";
        } else if (agent.indexOf("msie") > 0) {
            return "ie";
        } else if (agent.indexOf("opera") > 0) {
